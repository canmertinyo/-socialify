...
export type FindAllResult<T> = Query<HydratedDocument<T, unknown>[], HydratedDocument<T, unknown>>
...
export type UpdateResult<T> = Query<UpdateWriteOpResult, HydratedDocument<T, unknown>, unknown, T>
